# -*- coding: utf-8 -*-
# Exported from lora_rank_sensitivity_roberta_glue.ipynb
...
def apply_lora_to_attention(
    ...
    """Apply LoRA to RoBERTa attention; targets subset of {q,k,v,o}."""
    valid = {"q", "k", "v", "o"}
...
# SST-2 Table-2-style hyperparams; 5 epochs per sweep setting.
learning_rate = 5e-4
num_epochs = 5
...
# Bar plot: final SST-2 accuracy per setting.
...
# Bar order: Q, K, V, O, Q+K, Q+V, Q+K+V+O
